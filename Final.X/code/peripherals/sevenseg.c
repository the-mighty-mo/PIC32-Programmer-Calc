...
static unsigned char const digitSegments[]= {
    0b1000000, // 0
    0b1111001, // 1
    0b0100100, // 2
    0b0110000, // 3
...
**          
*/
static void SevenSeg_ConfigurePins()
{
...
**          
*/
unsigned char SevenSeg_GetDigitSegments(unsigned char d)
{
        ...
        unsigned char dp1, unsigned char dp2, unsigned char dp3, unsigned char dp4)
{
    ...
    digits[3] = SevenSeg_GetDigitSegments(d4);
...
{
    SevenSeg_WriteDigits(val & 0xF, (val & 0xF0) >> 4, (val & 0xF00) >> 8, (val & 0xF000) >> 12,
